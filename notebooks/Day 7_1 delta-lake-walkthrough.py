...
display(dbutils.fs.ls(f"{working_directory}/loans_parquet/"))
...
# MAGIC USING delta
# MAGIC AS SELECT * FROM parquet.`/FileStore/jagdshlk/deltaDemo/loans_parquet/`
...
# MAGIC %sql CONVERT TO DELTA parquet.`/FileStore/jagdshlk/deltaDemo/loans_parquet/`
